    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor_name', models.CharField(max_length=20, unique=True)),
                ('actor_name_ru', models.CharField(max_length=20, null=True, unique=True)),
                ('actor_name_en', models.CharField(max_length=20, null=True, unique=True)),
                ('actor_bio', models.TextField()),
                ('actor_bio_ru', models.TextField(null=True)),
                ('actor_bio_en', models.TextField(null=True)),
                ('actor_age', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(16), django.core.validators.MaxValueValidator(60)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('director_age', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(16), django.core.validators.MaxValueValidator(60)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pro', 'pro'), ('simple', 'simple')], default='simple', max_length=17)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', multiselectfield.db.fields.MultiSelectField(choices=[('144', '144'), ('360', '360'), ('480', '480'), ('720', '720'), ('1080', '1080')], max_length=32)),
                ...
                ('jenre', models.ManyToManyField(to='movie_app.genre')),
            ],
        ),
        migrations.CreateModel(
            name='Moments',
